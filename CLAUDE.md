...
- `OPENAI_API_KEY`: OpenAI API key for AI generation and moderation
...
Requires environment variables: `BROWSER_RENDERING_ACCOUNT_ID`, `BROWSER_RENDERING_API_TOKEN`, `OPENAI_API_KEY`
